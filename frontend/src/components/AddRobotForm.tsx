...
import { createRobot, type Robot } from "../api/robots";

type AddRobotFormProps = {
	onCreated: (robot: Robot) => void;
};

const AddRobotForm = ({ onCreated }: AddRobotFormProps) => {
	...
	return (
		<form onSubmit={handleSubmit}>
			...
			<div>
				<label className="add-robot-label" htmlFor="robot-name">
					Name
				</label>
			...
			<div>
				<label className="add-robot-label" htmlFor="robot-lat">
					Latitude
				</label>
			...
			<div>
				<label className="add-robot-label" htmlFor="robot-lon">
					Longitude
				</label>
